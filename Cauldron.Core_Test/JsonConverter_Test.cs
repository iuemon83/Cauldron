    ...
    public class JsonConverter_Test
    {
        ...
        public void SerializeJson()
        {
            var test = new CardSet("Sample", new[]
            {
                ...
                SampleCards.MagicShieldGoblin,
                SampleCards.SuperMagicShieldGoblin,
                ...
                SampleCards.RiderGoblin,
                SampleCards.WarGoblin,
                ...
                SampleCards.SelectDamage,
                SampleCards.RandomDamage,
                SampleCards.BounceDeck,
                SampleCards.BounceHand,
                SampleCards.Sword,
                SampleCards.Shield,
