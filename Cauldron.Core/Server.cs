...
namespace Cauldron.Core
{
    class Server
    {
        ...
        private readonly Dictionary<Guid, Func<string, Guid>> askCardActionsByPlayerId
            = new Dictionary<Guid, Func<string, Guid>>();
        ...
        public Guid AskCard(Guid playerId, string targetCardType)
        {
        ...
        public Guid RegisterPlayer(string name, IEnumerable<Guid> deckGuidList, Func<string, Guid> askCardAction)
        {
